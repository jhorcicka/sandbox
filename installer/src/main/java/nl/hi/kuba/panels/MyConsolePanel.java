...
public class MyConsolePanel extends UserInputConsolePanel {
    ...
    public MyConsolePanel(final Resources resources, final ObjectFactory factory, final RulesEngine rules,
            final PlatformModelMatcher matcher, final Console console, final Prompt prompt,
